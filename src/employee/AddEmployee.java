...
public class AddEmployee implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource() == b){
            try{
                Conn cc = new Conn();
                String q = "insert into employee(emp_fname,emp_lname,emp_dob,emp_age,emp_address,emp_phone,emp_email,emp_education,emp_post,emp_nid_no) "
                        + "values('"+a+"','"+bb+"','"+d+"','"+c+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"')";
